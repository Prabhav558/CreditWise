      ...
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-foreground">CreditWise</h3>
          ...
          {/* Developers Section */}
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-foreground">Developers</h3>
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground">Vatsala Singh</p>
            </div>
          </div>

          {/* About Our Technology Section */}
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-foreground">About Our Technology</h3>
            <p className="text-muted-foreground leading-relaxed">
