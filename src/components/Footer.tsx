      ...
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-primary-foreground dark:text-foreground">{t('footer.creditwise')}</h3>
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-primary-foreground dark:text-foreground">{t('footer.technology')}</h3>
            <p className="text-primary-foreground/80 dark:text-muted-foreground leading-relaxed">
